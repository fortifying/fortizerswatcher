...
from fortizers.modules.helper_funcs.misc import paginate_modules
from fortizers.modules.helper_funcs.verifier import verify_welcome
from fortizers.modules.sql import languages_sql as langsql

from fortizers.modules.connection import connect_button
from fortizers.modules.languages import set_language
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("fortizers.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        ...
        if len(args) >= 1:
            ...
            buttons = InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Add me to your group", url="https://t.me/fortifyingbot?startgroup=new")],
                [InlineKeyboardButton(text="⚙️ Connections", callback_data="main_connect")],
                [InlineKeyboardButton(text="🇺🇲 Language", callback_data="main_setlang"), InlineKeyboardButton(text="❓ Help", url="https://t.me/fortifyingbot?start=help")]])
