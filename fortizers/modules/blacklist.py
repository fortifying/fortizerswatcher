...
import fortizers.modules.sql.blacklist_sql as sql
from fortizers import dispatcher, LOGGER, spamcheck, OWNER_ID
from fortizers.modules.disable import DisableAbleCommandHandler
from telegram.utils.helpers import mention_markdown
from fortizers.modules.helper_funcs.chat_status import user_admin, user_not_admin
...
BLACKLIST_DEL_HANDLER = MessageHandler((Filters.text | Filters.command | Filters.sticker | Filters.photo) & Filters.chat_type.groups, del_blacklist)
