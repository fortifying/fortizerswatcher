...
from fortizers import dispatcher, MESSAGE_DUMP, LOGGER, spamcheck, OWNER_ID
...
from fortizers.modules.helper_funcs.string_handling import escape_invalid_curly_brackets
