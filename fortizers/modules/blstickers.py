...
import fortizers.modules.sql.blsticker_sql as sql
from fortizers import dispatcher, SUDO_USERS, LOGGER, spamcheck, OWNER_ID
...
from fortizers.modules.sql import users_sql
