...
from fortizers import dispatcher, updater, spamcheck, LOGGER
...
PERMANENT_PIN_SET_HANDLER = DisableAbleCommandHandler("permanentpin", permanent_pin_set, pass_args=True, filters=Filters.group)
